...
const TX = {
  hero: {
    ...
    sub: {
      de: "Werden Sie Partner von Capitalife und partizipieren Sie an einem leistungsbasierten Modell f\u00FCr langfristiges Wachstum.",
      en: "Partner with Capitalife and participate in a performance-driven model built for long-term growth.",
    } as T,
  ...
  overview: {
    ...
    h2a: { de: "Mit Empfehlungen", en: "Earn with Recommendations" } as T,
    h2b: { de: "nachhaltig mitverdienen", en: "that actually scale" } as T,
    intro: {
      de: "Als Partner verdienen Sie an der Performance von Capitalife \u2014 nicht auf Versprechen, sondern an echten Ergebnissen.",
      en: "As a partner, you earn a share of Capitalife's performance \u2014 not based on promises, but real results.",
    } as T,
    kpis: [
      { val: { de: "Bis zu 60\u00A0%", en: "Up to 60\u00A0%" } as T, desc: { de: "Bis zu 60\u00A0% unserer Erfolgsbeteiligung", en: "Earn up to 60% of our performance share" } as T },
      { val: { de: "40%", en: "40%" } as T, desc: { de: "Standardbeteiligung f\u00FCr qualifizierte Partner", en: "Standard participation for qualified partners" } as T },
    ...
    cta: { de: "Jetzt mit uns verdienen", en: "Start Earning with Us" } as T,
    cards: [
      ...
      { title: { de: "Hinweis", en: "Note" } as T, heading: { de: "Vertrauliche Strukturen", en: "Confidential Structures" } as T, text: { de: "Interne Verg\u00FCtungsstrukturen werden nicht \u00F6ffentlich kommuniziert.", en: "Internal compensation structures are not publicly disclosed." } as T },
    ],
  },
  model: {
